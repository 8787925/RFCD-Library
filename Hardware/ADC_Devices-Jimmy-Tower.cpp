...
uint16_t ADC_Devices::readNew(SensorList adcName){
...
void ADC_Devices::clearCurrent(SensorList adcName){
...
void ADC_Devices::setupNew(SensorList adcName){
...
uint16_t ADC_Devices::triggerADC(SensorList ADCobj){
	uint16_t temp = 0;
